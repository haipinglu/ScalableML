...
- [Task 4](#4-exercises): To finish by the following Tuesday 22nd Feb. ***Exercise***
...
- [RDD Programming Guide](https://spark.apache.org/docs/3.2.1/rdd-programming-guide.html): Most are useful to know in this module.
- [Spark SQL, DataFrames and Datasets Guide](https://spark.apache.org/docs/3.2.1/sql-programming-guide.html): `Overview` and `Getting Started` recommended (skipping those without Python example).
- [Machine Learning Library (MLlib) Guide](https://spark.apache.org/docs/3.2.1/ml-guide.html)
- [ML Pipelines](https://spark.apache.org/docs/3.2.1/ml-pipeline.html)
- [Apache Spark Examples](https://spark.apache.org/examples.html)
- [Basic Statistics - DataFrame API](https://spark.apache.org/docs/3.2.1/ml-statistics.html)
- [Basic Statistics - RDD API](https://spark.apache.org/docs/3.2.1/mllib-statistics.html): much **richer**
...
**Tip**: Try to use as much DataFrame APIs as possible by referring to the [PySpark API documentation](https://spark.apache.org/docs/3.2.1/api/python/index.html). When you try to program something, try to search whether there is a function in the API already.
...
As stated in the [RDD Programming Guide](https://spark.apache.org/docs/3.2.1/rdd-programming-guide.html#parallelized-collections), Spark allows for parallel operations in a program to be executed on a cluster with the following abstractions:
...
### [Shared Variables](https://spark.apache.org/docs/3.2.1/rdd-programming-guide.html#shared-variables)
...
#### [Accumulators](https://spark.apache.org/docs/3.2.1/rdd-programming-guide.html#accumulators)
...
Along with the introduction of `SparkSession`, the `resilient distributed dataset` (RDD) was replaced by [`dataset`](http://spark.apache.org/docs/3.2.1/api/scala/index.html#org.apache.spark.sql.Dataset). Again, these are objects that can be worked on in parallel. The available operations are:
...
[MLlib](https://spark.apache.org/docs/3.2.1/ml-guide.html) is Spark’s machine learning (ML) library. It provides:
...
A list of some of the available ML features is available [here](http://spark.apache.org/docs/3.2.1/ml-features.html).

**Clarification on whether Estimator is a transformer**. See [Estimators](https://spark.apache.org/docs/3.2.1/ml-pipeline.html#estimators)
...
This example is adapted from the [ML Pipeline API](https://spark.apache.org/docs/3.2.1/ml-pipeline.html), with minor changes and additional explanations.
