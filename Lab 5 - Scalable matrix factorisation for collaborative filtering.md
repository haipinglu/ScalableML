# Lab 5: Matrix Factorisation for Collaborative Filtering in Recommender Systems
...
- [Task 1](#1-Movie-recommendation-via-collaborative-filtering): To finish in the lab session on 10th March. **Essential**
- [Task 2](#2-exercises): To finish by the following Wednesday 15th March. ***Exercise***
- [Task 3](#3-additional-ideas-to-explore-optional): To explore further. *Optional*

### Suggested reading

- [Collaborative Filtering in Spark](https://spark.apache.org/docs/3.3.1/ml-collaborative-filtering.html)
...
- [Python API on ALS for recommender system](https://spark.apache.org/docs/3.3.1/api/python/reference/api/pyspark.ml.recommendation.ALS.html)
